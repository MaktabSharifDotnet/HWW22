...
namespace App.Domain.Core.Contract.CartAgg.Service
{
    public interface ICartService
    {
        ...
        public Task<int> RemoveProduct(int userId,int productId, CancellationToken cancellationToken);
        public  Task<int> DecreaseItem(int userId, int productId, CancellationToken cancellationToken);

        public Task RemoveCart(int cartId, CancellationToken cancellationToken);
    }
}
