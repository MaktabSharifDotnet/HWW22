    ...
    public partial class seeddatadescription : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "Title" },
                values: new object[] { "یک کوهنورد حرفه‌ای می‌داند که کوله‌پشتی مهم‌ترین یار او در مسیرهای سخت است. کوله پشتی کوهنوردی 50 لیتری، با مهندسی ارگونومیک دقیق طراحی شده تا وزن سنگین تجهیزات را به جای شانه‌ها، روی لگن و پاها تقسیم کند. این ویژگی باعث می‌شود که حتی در پیمایش‌های طولانی و چند روزه، احساس خستگی کمتری داشته باشید و از آسیب به ستون فقرات جلوگیری شود. سیستم پشتی دارای توری عرق‌گیر است که با ایجاد فاصله بین کوله و کمر، جریان هوا را برقرار کرده و از تعریق بیش از حد جلوگیری می‌کند.\r\n\r\nظرفیت 50 لیتری این کوله فضای کافی برای کیسه خواب، لباس‌های اضافی، ظروف پخت‌وپز و آب و غذا را فراهم می‌کند. جیب‌های متعدد زیپ‌دار و کشسانی در طرفین و روی کلاهک کوله، دسترسی سریع به لوازمی مثل نقشه، قطب‌نما، بطری آب و تنقلات را ممکن می‌سازد. همچنین بندهای مخصوصی برای حمل زیرانداز، باتوم کوهنوردی و کلنگ یخ روی بدنه تعبیه شده است.\r\n\r\nجنس پارچه این کوله از نوع برزنت ضد خش و مقاوم در برابر پارگی است که در برخورد با صخره‌ها و شاخ و برگ درختان آسیب نمی‌بیند. علاوه بر این، یک کاور ضد باران (Rain Cover) در جیب مخفی پایین کوله وجود دارد که در شرایط طوفانی می‌توانید آن را روی کل کوله بکشید تا وسایلتان کاملاً خشک بمانند. سگک‌های نشکن و زیپ‌های روان YKK از دیگر ویژگی‌هایی هستند که کیفیت ساخت بالای این محصول را تضمین می‌کنند.", "کوله پشتی کوهنوردی 50 لیتری" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Description",
                value: "گوشی موبایل اپل مدل iPhone 13 ظرفیت 128 گیگابایت");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "Title" },
                values: new object[] { "لپ تاپ 15.6 اینچی ایسوس مدل TUF Gaming", "لپ تاپ ایسوس" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "Description", "Title" },
                values: new object[] { "کفش مخصوص دویدن مردانه مدل Revolution 6", "کفش ورزشی نایکی" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4,
                columns: new[] { "Description", "Title" },
                values: new object[] { "یخچال و فریزر دوقلو 40 فوت پارس", "یخچال فریزر دوقلو" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 5,
                column: "Description",
                value: "کتاب کدنویسی تمیز اثر رابرت سی. مارتین (مرجع برنامه‌نویسان)");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                column: "Description",
                value: "چادر مسافرتی فنری ضد آب مناسب برای کمپینگ و طبیعت‌گردی");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 7,
                columns: new[] { "Description", "Title" },
                values: new object[] { "کوله پشتی 50 لیتری مناسب برای کوهنوردی و سفر چند روزه", "کوله پشتی کوهنوردی" });
        }
    }
}
